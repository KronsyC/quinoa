...
entry_block:
  ...
  %0 = call i64 @"[Xhw9rtolYK].io.fn_println(PR_int8*)"(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @str, i32 0, i32 0))
  ret i32 0
}

define i64 @"[Xhw9rtolYK].io.fn_println(PR_int8*)"(i8* %message) {
entry_block:
  ...
  %3 = call i64 @"[Xhw9rtolYK].io.fn_strlen(PR_int8*)"(i8* %2)
  %4 = call i64 @"[CP5JI5HwpG].syscall.fn_write(PR_int64,PR_int64,PR_int64)"(i64 1, i64 %1, i64 %3)
  ret i64 %4
}

define i64 @"[Xhw9rtolYK].io.fn_strlen(PR_int8*)"(i8* %str) {
entry_block:
...
define i64 @"[CP5JI5HwpG].syscall.fn_write(PR_int64,PR_int64,PR_int64)"(i64 %fd, i64 %ptr, i64 %len) {
entry_block:
