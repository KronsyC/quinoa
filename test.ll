...
entry_block:
  ...
  %1 = call i64 (i32, i32, ...) @"[KJIjS9b4AN].primitives.fn___syscall__(PR_int32,...PR_int32[])"(i32 2, i32 3, i32 1, i32 %0, i32 2)
  ret i32 0
}

declare i64 @"[KJIjS9b4AN].primitives.fn___syscall__(PR_int32,...PR_int32[])"(i32, i32, ...)

define i64 @"[GNNIdNea7J].io.fn_println(PR_string)"(i8* %message) {
entry_block:
