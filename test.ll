...
entry_block:
  ...
  %0 = call i32 @"[TQXWFFqngJ].io.fn_println(PR_string)"(i8* %"loaded var 'message'")
  store i32 %0, i32* %"var val", align 4
  %"loaded var 'val'" = load i32, i32* %"var val", align 4
  ret i32 %"loaded var 'val'"
}

define i32 @"[TQXWFFqngJ].io.fn_println(PR_string)"(i8* %message) {
entry_block:
