...
entry_block:
  ...
  call void @"fn_$ZQFGAO9a5e::Assert::equals(PR_int32,PR_int32)"(i32 %0, i32 2)
  call void @"fn_$ZQFGAO9a5e::Assert::truthy(PR_int8)"(i8 1)
  ret i32 0
}

define i64 @"fn_$gjRL4VR6Lk::IO::println(PR_int8*)"(i8* %message) {
entry_block:
  ...
  %1 = call i64 @"fn_$gjRL4VR6Lk::IO::print(PR_int8*)"(i8* %0)
  store i64 %1, i64* %"var len", align 4
  call void @"fn_$gjRL4VR6Lk::IO::putc(PR_int8)"(i8 10)
  %2 = load i64, i64* %"var len", align 4
  %3 = add i64 %2, 1
  ret i64 %3
}

define i64 @"fn_$gjRL4VR6Lk::IO::print(PR_int8*)"(i8* %message) {
entry_block:
  %"param message" = alloca i8*, align 8
  store i8* %message, i8** %"param message", align 8
  %"var len" = alloca i64, align 8
  ...
  %3 = call i64 @"fn_$gjRL4VR6Lk::IO::strlen(PR_int8*)"(i8* %2)
...
define void @"fn_$gjRL4VR6Lk::IO::putc(PR_int8)"(i8 %ch) {
entry_block:
...
define i64 @"fn_$gjRL4VR6Lk::IO::strlen(PR_int8*)"(i8* %str) {
entry_block:
...
define i64 @"fn_$gjRL4VR6Lk::IO::read(PR_int8*,PR_int64)"(i8* %str, i64 %len) {
entry_block:
  %"param str" = alloca i8*, align 8
  store i8* %str, i8** %"param str", align 8
...
define void @"fn_$ZQFGAO9a5e::Assert::truthy(PR_int8)"(i8 %value) {
entry_block:
...
define void @"fn_$ZQFGAO9a5e::Assert::equals(PR_int32,PR_int32)"(i32 %v1, i32 %v2) {
entry_block:
...
if_exec:                                          ; preds = %entry_block
  call void @"fn_$ZQFGAO9a5e::Assert::assert_error(PR_int8*)"(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @str.1, i32 0, i32 0))
  br label %if_cont
...
define void @"fn_$ZQFGAO9a5e::Assert::assert_error(PR_int8*)"(i8* %message) {
entry_block:
  %"param message" = alloca i8*, align 8
  store i8* %message, i8** %"param message", align 8
  %0 = call i64 @"fn_$gjRL4VR6Lk::IO::print(PR_int8*)"(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str, i32 0, i32 0))
  %1 = load i8*, i8** %"param message", align 8
  %2 = call i64 @"fn_$gjRL4VR6Lk::IO::println(PR_int8*)"(i8* %1)
