...
entry_block:
  ...
  %0 = call i64 @"[Fgw7fvXlDA].io.fn_println(PR_int8*)"(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @str, i32 0, i32 0))
  ret i32 0
}

define i64 @"[Fgw7fvXlDA].io.fn_println(PR_int8*)"(i8* %message) {
entry_block:
  ...
  %2 = call i64 @"[Fgw7fvXlDA].io.fn_strlen(PR_int8*)"(i8* %1)
  %3 = call i64 @"[1MWeS9EOXh].syscall.fn_write(PR_int64,PR_int8*,PR_int64)"(i64 1, i8* %0, i64 %2)
  store i64 %3, i64* %"var len", align 4
  call void @"[Fgw7fvXlDA].io.fn_putc(PR_int8)"(i8 10)
  %4 = load i64, i64* %"var len", align 4
  %5 = add i64 %4, 1
  ret i64 %5
}

define i64 @"[Fgw7fvXlDA].io.fn_strlen(PR_int8*)"(i8* %str) {
entry_block:
...
define void @"[Fgw7fvXlDA].io.fn_putc(PR_int8)"(i8 %ch) {
entry_block:
  ...
  %1 = call i64 @"[1MWeS9EOXh].syscall.fn_write(PR_int64,PR_int8*,PR_int64)"(i64 1, i8* %0, i64 1)
  ret void
}

define i64 @"[Fgw7fvXlDA].io.fn_read(PR_int8*,PR_int64)"(i8* %str, i64 %len) {
entry_block:
  %"param str" = alloca i8*, align 8
  store i8* %str, i8** %"param str", align 8
  ...
  %2 = call i64 @"[1MWeS9EOXh].syscall.fn_read(PR_int64,PR_int8*,PR_int64)"(i64 0, i8* %0, i64 %1)
  store i64 %2, i64* %"var readLen", align 4
  %3 = load i64, i64* %"var readLen", align 4
  ret i64 %3
}

define i64 @"[1MWeS9EOXh].syscall.fn_close(PR_int64)"(i64 %fd) {
entry_block:
...
define i64 @"[1MWeS9EOXh].syscall.fn_open(PR_int8*,PR_int32,PR_int32)"(i8* %filename, i32 %flags, i32 %mode) {
entry_block:
...
define i64 @"[1MWeS9EOXh].syscall.fn_write(PR_int64,PR_int8*,PR_int64)"(i64 %fd, i8* %ptr, i64 %len) {
entry_block:
  %"param fd" = alloca i64, align 8
  store i64 %fd, i64* %"param fd", align 4
...
define i64 @"[1MWeS9EOXh].syscall.fn_read(PR_int64,PR_int8*,PR_int64)"(i64 %fd, i8* %ptr, i64 %len) {
entry_block:
  %"param fd" = alloca i64, align 8
  store i64 %fd, i64* %"param fd", align 4
  %"param ptr" = alloca i8*, align 8
