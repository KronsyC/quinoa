...
@prop._JoeNmnZB5l_.IO.stdout = linkonce global i32 1

define i32 @fn.HelloWorld.main.PR_int32.PR_int8-p-p(i32 %argc, i8** %argv) {
entry_block:
  ...
  %0 = call i64 @fn._JoeNmnZB5l_.IO.println.PR_int8-p(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @str, i32 0, i32 0))
  ret i32 0
}

define i64 @fn._JoeNmnZB5l_.IO.println.PR_int8-p(i8* %message) {
entry_block:
  %"param message" = alloca i8*, align 8
  store i8* %message, i8** %"param message", align 8
  %len = alloca i64, align 8
  %0 = load i8*, i8** %"param message", align 8
  %1 = call i64 @fn._JoeNmnZB5l_.IO.print.PR_int8-p(i8* %0)
  store i64 %1, i64* %len, align 4
  call void @fn._JoeNmnZB5l_.IO.putc.PR_int8(i8 10)
  %2 = load i64, i64* %len, align 4
  %3 = add i64 %2, 1
  ret i64 %3
}

define i64 @fn._JoeNmnZB5l_.IO.print.PR_int8-p(i8* %message) {
entry_block:
  %"param message" = alloca i8*, align 8
  store i8* %message, i8** %"param message", align 8
  %len = alloca i64, align 8
  %0 = load i32, i32* @prop._JoeNmnZB5l_.IO.stdout, align 4
  %1 = load i8*, i8** %"param message", align 8
  %2 = ptrtoint i8* %1 to i64
  %3 = load i8*, i8** %"param message", align 8
  %4 = call i64 @fn._nf5wpRpRxN_.CString.len.PR_int8-p(i8* %3)
...
define void @fn._JoeNmnZB5l_.IO.putc.PR_int8(i8 %ch) {
entry_block:
...
define i64 @fn._JoeNmnZB5l_.IO.read.PR_int8-p.PR_int64(i8* %str, i64 %len) {
entry_block:
...
define i64 @fn._JoeNmnZB5l_.IO.strlen.PR_int8-p(i8* %str) {
entry_block:
  %"param str" = alloca i8*, align 8
  store i8* %str, i8** %"param str", align 8
...
define i64 @fn._nf5wpRpRxN_.CString.len.PR_int8-p(i8* %str) {
entry_block:
  %"param str" = alloca i8*, align 8
  store i8* %str, i8** %"param str", align 8
  %i = alloca i64, align 8
...
main_entry:
  %0 = call i32 @fn.HelloWorld.main.PR_int32.PR_int8-p-p(i32 %argc, i8** %argv)
  ret i32 %0
}
