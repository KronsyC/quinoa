...
entry_block:
  ...
  %0 = call i64 @"[rVaOAzCaH3].io::fn_println(PR_int8*)"(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @str, i32 0, i32 0))
  ret i32 0
}

define i64 @"[rVaOAzCaH3].io::fn_println(PR_int8*)"(i8* %message) {
entry_block:
  ...
  %3 = call i64 @"[rVaOAzCaH3].io::fn_strlen(PR_int8*)"(i8* %2)
  %4 = call i64 @write(i64 1, i64 %1, i64 %3)
  store i64 %4, i64* %"var len", align 4
  call void @"[rVaOAzCaH3].io::fn_putc(PR_int8)"(i8 10)
  %5 = load i64, i64* %"var len", align 4
  %6 = add i64 %5, 1
  ret i64 %6
}

define i64 @"[rVaOAzCaH3].io::fn_strlen(PR_int8*)"(i8* %str) {
entry_block:
...
define void @"[rVaOAzCaH3].io::fn_putc(PR_int8)"(i8 %ch) {
entry_block:
...
define i64 @"[rVaOAzCaH3].io::fn_read(PR_int8*,PR_int64)"(i8* %str, i64 %len) {
entry_block:
  %"param str" = alloca i8*, align 8
  store i8* %str, i8** %"param str", align 8
  ...
  %3 = call i64 @"[2Wk83FJMOU].syscall::fn_read(PR_int64,PR_int64,PR_int64)"(i64 0, i64 %1, i64 %2)
  ret i64 %3
}

define i64 @"[2Wk83FJMOU].syscall::fn_read(PR_int64,PR_int64,PR_int64)"(i64 %fd, i64 %ptr, i64 %len) {
entry_block:
