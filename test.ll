...
entry_block:
  ...
  call void @"[8NzVqIoFc3].assertions.fn_equals(PR_int32,PR_int32)"(i32 1, i32 1)
  ret i32 0
}

declare void @"[8NzVqIoFc3].assertions.fn_equals(PR_int32,PR_int32)"(i32, i32)

define i64 @"[vhW8pGVveB].io.fn_println(PR_int8*)"(i8* %message) {
entry_block:
  ...
  %3 = call i64 @"[vhW8pGVveB].io.fn_strlen(PR_int8*)"(i8* %2)
  %4 = call i64 @"[5PBagCrBdI].syscall.fn_write(PR_int64,PR_int64,PR_int64)"(i64 1, i64 %1, i64 %3)
  store i64 %4, i64* %"var len", align 4
  call void @"[vhW8pGVveB].io.fn_putc(PR_int8)"(i8 10)
  %5 = load i64, i64* %"var len", align 4
  %6 = add i64 %5, 1
  ret i64 %6
}

define i64 @"[vhW8pGVveB].io.fn_strlen(PR_int8*)"(i8* %str) {
entry_block:
...
define void @"[vhW8pGVveB].io.fn_putc(PR_int8)"(i8 %ch) {
entry_block:
  %"param ch" = alloca i8, align 1
  store i8 %ch, i8* %"param ch", align 1
  %0 = ptrtoint i8* %"param ch" to i64
  %1 = call i64 @"[5PBagCrBdI].syscall.fn_write(PR_int64,PR_int64,PR_int64)"(i64 1, i64 %0, i64 1)
  ret void
}

define i64 @"[vhW8pGVveB].io.fn_read(PR_int8*,PR_int64)"(i8* %str, i64 %len) {
entry_block:
  %"param str" = alloca i8*, align 8
  store i8* %str, i8** %"param str", align 8
  ...
  %3 = call i64 @"[5PBagCrBdI].syscall.fn_read(PR_int64,PR_int64,PR_int64)"(i64 0, i64 %1, i64 %2)
  ret i64 %3
}

define i64 @"[5PBagCrBdI].syscall.fn_exit(PR_int64)"(i64 %status) {
entry_block:
...
define i64 @"[5PBagCrBdI].syscall.fn_mmap(PR_int64,PR_int64,PR_int64,PR_int64,PR_int64,PR_int64)"(i64 %addr, i64 %len, i64 %prot, i64 %flags, i64 %fd, i64 %off) {
entry_block:
...
define i64 @"[5PBagCrBdI].syscall.fn_lseek(PR_int64,PR_int64,PR_int64)"(i64 %fd, i64 %offset, i64 %whence) {
entry_block:
  %"param fd" = alloca i64, align 8
  store i64 %fd, i64* %"param fd", align 4
...
define i64 @"[5PBagCrBdI].syscall.fn_close(PR_int64)"(i64 %fd) {
entry_block:
  %"param fd" = alloca i64, align 8
  store i64 %fd, i64* %"param fd", align 4
  %0 = load i64, i64* %"param fd", align 4
...
define i64 @"[5PBagCrBdI].syscall.fn_open(PR_int64,PR_int32,PR_int32)"(i64 %filename, i32 %flags, i32 %mode) {
entry_block:
...
define i64 @"[5PBagCrBdI].syscall.fn_write(PR_int64,PR_int64,PR_int64)"(i64 %fd, i64 %ptr, i64 %len) {
entry_block:
  %"param fd" = alloca i64, align 8
  store i64 %fd, i64* %"param fd", align 4
...
define i64 @"[5PBagCrBdI].syscall.fn_read(PR_int64,PR_int64,PR_int64)"(i64 %fd, i64 %ptr, i64 %len) {
entry_block:
  %"param fd" = alloca i64, align 8
  store i64 %fd, i64* %"param fd", align 4
  %"param ptr" = alloca i64, align 8
