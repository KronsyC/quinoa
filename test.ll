...
entry_block:
  ...
  %0 = call i64 @"[8wze7567jU].io.fn_println(PR_string)"(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @str, i32 0, i32 0))
  %1 = call i64 (i32, i32, ...) @"[ZMyQVtlAOv].primitives.fn___syscall__(PR_int32,...PR_int32[])"(i32 2, i32 0)
  ret i32 0
}

define i64 @"[8wze7567jU].io.fn_println(PR_string)"(i8* %message) {
entry_block:
...
define i64 @"[ZMyQVtlAOv].primitives.fn___syscall__(PR_int32,...PR_int32[])"(i32 %callNo, i32 %"+vararg_count", ...) {
entry_block:
