...
entry_block:
  ...
  %0 = call i64 @fn._4RGAhOFGPc_.IO.println.PR_int8-p(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @str, i32 0, i32 0))
  ret i32 0
}

define i64 @fn._4RGAhOFGPc_.IO.println.PR_int8-p(i8* %message) {
entry_block:
  ...
  %1 = call i64 @fn._4RGAhOFGPc_.IO.print.PR_int8-p(i8* %0)
  store i64 %1, i64* %"var len", align 4
  call void @fn._4RGAhOFGPc_.IO.putc.PR_int8(i8 10)
  %2 = load i64, i64* %"var len", align 4
  %3 = add i64 %2, 1
  ret i64 %3
}

define i64 @fn._4RGAhOFGPc_.IO.print.PR_int8-p(i8* %message) {
entry_block:
  %"param message" = alloca i8*, align 8
  store i8* %message, i8** %"param message", align 8
  %"var len" = alloca i64, align 8
  ...
  %3 = call i64 @fn._4RGAhOFGPc_.IO.strlen.PR_int8-p(i8* %2)
...
define void @fn._4RGAhOFGPc_.IO.putc.PR_int8(i8 %ch) {
entry_block:
...
define i64 @fn._4RGAhOFGPc_.IO.strlen.PR_int8-p(i8* %str) {
entry_block:
...
define i64 @fn._4RGAhOFGPc_.IO.read.PR_int8-p.PR_int64(i8* %str, i64 %len) {
entry_block:
  %"param str" = alloca i8*, align 8
  store i8* %str, i8** %"param str", align 8
